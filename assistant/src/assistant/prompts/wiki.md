...
3. Rebuild `wiki/now.md` in full — its **Tasks** section by sweeping every wiki page's `## Tasks`, and its **Upcoming** section by sweeping every live page's dated event bullets for the next 14 days, so a task or event ingest failed to mirror still reaches the dashboard within a day.
